...
s=s.replace("S=requests.Session(); S.headers.update({'User-Agent':'Mozilla/5.0 Chrome/126','Accept-Language':'tr-TR,tr;q=.9,en;q=.6'})", "S=requests.Session(); S.headers.update({'User-Agent':'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 Chrome/126 Safari/537.36','Accept-Language':'tr-TR,tr;q=.9,en;q=.6','Referer':'https://universe.leagueoflegends.com/','Origin':'https://universe.leagueoflegends.com'})")
